import { isFunction, isRegExp, keys, map, result as getResult } from 'lodash-es';
...
export class Router {
  ...
  _bindRoutes() {
    ...
    const routes = getResult(this, 'routes');
    let route;
  ...
  _extractParameters(route, fragment) {
    ...
    return map(params, function (param, i) {
      // Don't decode the search params (last parameter).
...
// Mix in EventsMixin
Object.assign(Router.prototype, EventsMixin);
