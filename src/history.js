import { extend, some, result as getResult } from 'lodash-es';
...
export class History {
  constructor() {
    ...
    // Initialize root to default value
    this.root = '/';
  }
  ...
  start(options) {
    ...
    this._hasHashChange = typeof window !== 'undefined' &&
      'onhashchange' in window &&
      (document.documentMode === undefined || document.documentMode > 7);
    this._useHashChange = this._wantsHashChange && this._hasHashChange;
    this._wantsPushState = !!this.options.pushState;
    this._hasPushState = typeof window !== 'undefined' &&
  ...
  loadUrl(fragment) {
    ...
    return some(this.handlers, (handler) => {
...
// Mix in EventsMixin
Object.assign(History.prototype, EventsMixin);

// Create the default Backbone.history singleton.
